...
interface IEulerSwap {
    ...
    /// @notice Approves the vaults to access the EulerSwap instance's tokens,
    /// and enables
    /// vaults as collateral. Can be invoked by anybody, and is harmless if
    /// invoked again.
    /// Calling this function is optional: EulerSwap can be activated on the
    /// first swap.
    function activate() external;

    /// @notice Function that defines the shape of the swapping curve. Returns
    /// true iff
    /// the specified reserve amounts would be acceptable (ie it is above and
    /// to-the-right
    ...
    /// @notice Returns the address of the Ethereum Vault Connector (EVC) used
    /// by this contract.
