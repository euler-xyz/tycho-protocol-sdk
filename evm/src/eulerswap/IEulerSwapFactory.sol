...
interface IEulerSwapFactory {
    ...
    /// @param params Core pool parameters including vaults, account, and fee
    /// settings
    /// @param curveParams Parameters defining the curve shape including prices
    /// and concentrations
    ...
    /// @notice Get the address of the pool at the given index in the `allPools`
    /// array.
