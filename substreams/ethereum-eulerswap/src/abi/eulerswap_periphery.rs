...
pub mod functions {
    ...
    impl GetLimits {
        const METHOD_ID: [u8; 4] = [102u8, 75u8, 141u8, 122u8];
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ethabi::Token::Address(ethabi::Address::from_slice(&self.euler_swap)),
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct QuoteExactInput {
        pub euler_swap: Vec<u8>,
        pub token_in: Vec<u8>,
        pub token_out: Vec<u8>,
        pub amount_in: substreams::scalar::BigInt,
    }
    impl QuoteExactInput {
    ...
    impl substreams_ethereum::Function for QuoteExactInput {
        const NAME: &'static str = "quoteExactInput";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for QuoteExactInput {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct QuoteExactOutput {
        pub euler_swap: Vec<u8>,
        pub token_in: Vec<u8>,
        pub token_out: Vec<u8>,
        pub amount_out: substreams::scalar::BigInt,
    }
    impl QuoteExactOutput {
        const METHOD_ID: [u8; 4] = [153u8, 93u8, 97u8, 170u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::Function for QuoteExactOutput {
        const NAME: &'static str = "quoteExactOutput";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for QuoteExactOutput {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl SwapExactIn {
        const METHOD_ID: [u8; 4] = [192u8, 231u8, 232u8, 112u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::Function for SwapExactIn {
        const NAME: &'static str = "swapExactIn";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl SwapExactOut {
        const METHOD_ID: [u8; 4] = [8u8, 60u8, 45u8, 199u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::Function for SwapExactOut {
        const NAME: &'static str = "swapExactOut";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
